...
!(function (t, e) {
  ...
  class Jn extends H {
    ...
    toHtml() {
      const t = document.createElement("div");
      t.innerHTML = this._maybeSanitize(this._config.property);
    ...
    _setContent(t, e, i) {
      ...
      n &&
        ((e = this._resolvePossibleFunction(e))
          ? o(e)
            ? this._putElementInproperty(r(e), n)
            : this._config.html
  ...
  class cs extends W {
      ...
      return (
        this.tip ||
          (this.tip = this._createTipElement(
            this._newContent || this._getContentForproperty()
          )),
        this.tip
      );
    }
    _createTipElement(t) {
      const e = this._getpropertyFactory(t).toHtml();
      if (!e) return null;
    ...
    _getpropertyFactory(t) {
      return (
        this._propertyFactory
          ? this._propertyFactory.changeContent(t)
          : (this._propertyFactory = new Jn({
              ...this._config,
              content: t,
